...
func (dao *VoluntarioDAO) FindAllThatMatches(text string) (voluntários []modelos.Voluntário, err error) {
	query := fmt.Sprintf("SELECT %s FROM voluntario WHERE nome_completo LIKE ?", dao.fields)
